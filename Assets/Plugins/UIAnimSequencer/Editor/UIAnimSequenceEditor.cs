...
public class UIAnimSequenceEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		EditorGUILayout.PropertyField(serializedObject.FindProperty("m_playOnAwake"), true, new GUILayoutOption[0]);
		EditorGUILayout.PropertyField(serializedObject.FindProperty("m_setToInitialStateOnAwake"), true, new GUILayoutOption[0]);
		m_list.DoLayoutList();
		serializedObject.ApplyModifiedProperties();
	}
